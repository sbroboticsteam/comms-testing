...
import sys
sys.path.append('/home/pringles/AutoCarFirmware/2019-2020-IARRC/USB_Firmware/IMU') # append path of directory containing each module
from Yost_Labs import USB_IMU
from TestReceiver import TestReceiver

# config constants (change values for your own modules)
CONFIG = '../configs/imu.json'
HOSTS = [USB_IMU, TestReceiver]
